//! Regression test for https://github.com/dmtrKovalenko/ffs.nvim/issues/381
//!
...
use ffs_search::{Constraint, FilePickerOptions, FuzzySearchOptions, PaginationArgs, QueryParser};
