...
use ffs_budget::{smart_truncate, TruncationOutcome};
use ffs_engine::Engine;
use ffs_symbol::lang::detect_file_type;
use ffs_symbol::types::{FileType, Lang, OutlineEntry};
...
pub fn per_hit_budget_bytes(total_token_budget: u64, hit_count: usize) -> usize {
    let split = ffs_budget::BudgetSplit::default_for(total_token_budget);
